...
<style>
     :root {
        --primary-color: #5e8bbb; /* Darker Blue for a richer feel */
        --secondary-color: #e3e8edff; /* Muted Gray for text */
        --accent-color: #28a745; /* Vibrant Green for emphasis */
        --dark-bg: #343a40; /* Dark Charcoal */
        --light-bg: #f8f9fa; /* White Smoke */
        --text-light: #ffffff;
        --text-dark: #333333;
    }
